...
const Root$2 = newStyled.div`
  background-color: #a2a2a2;
  height: 100vh;
`;
const CartPageWrapper = newStyled.div`
  width: 430px;
...
const Content = newStyled.div`
  height: 100%;
`;
const Line$2 = newStyled.hr`
  border: none;
  border-top: 1px solid rgba(0, 0, 0, 0.1);
  margin: 0;
`;
const OrderButton = newStyled.button`
  width: 100%;
  height: 60px;
...
const EmptyCart = newStyled.div`
  ...
  padding: 36px 24px;
`;
const HeaderTitle$1 = newStyled.h2`
  font-weight: 800;
  font-size: 20px;
  margin: 0;
`;
const CartContentWrapper = newStyled.div`
  padding: 36px 24px;
  overflow-y: scroll;
`;
const CartItemList$1 = newStyled.ul`
  list-style: none;
  overflow-y: auto;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          d: "M2.58325 12.0007L1.41195 11.0636L0.662315 12.0007L1.41195 12.9377L2.58325 12.0007ZM23.4166 13.5007C24.245 13.5007 24.9166 12.8291 24.9166 12.0007C24.9166 11.1722 24.245 10.5007 23.4166 10.5007V13.5007ZM10.9166 1.58398L9.74528 0.646942L1.41195 11.0636L2.58325 12.0007L3.75456 12.9377L12.0879 2.52103L10.9166 1.58398ZM2.58325 12.0007L1.41195 12.9377L9.74528 23.3544L10.9166 22.4173L12.0879 21.4803L3.75456 11.0636L2.58325 12.0007ZM2.58325 12.0007V13.5007H23.4166V12.0007V10.5007H2.58325V12.0007Z",
          fill: "white"
        }
      )
    }
...
newStyled.div`
  ...
  font-weight: 700;
`;
const HeaderIcon = newStyled.button`
...
function Header({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderTitle, { children: showBackButton ? /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderIcon, { onClick: onBackClick, children: /* @__PURE__ */ jsxRuntimeExports.jsx(BackArrow, {}) }) : title }) });
}
...
const cartReducer = (state, action) => {
  switch (action.type) {
    ...
    case "ADD_ITEM_QUANTITY":
      return state.map(
        (item) => item.id === action.payload.id ? { ...item, quantity: action.payload.quantity || item.quantity + 1 } : item
      );
    case "SUB_ITEM_QUANTITY":
      return state.map(
        (item) => item.id === action.payload.id ? {
          ...item,
          quantity: action.payload.quantity || Math.max(1, item.quantity - 1)
        } : item
      );
    default:
      return state;
...
function CartProvider({ children }) {
  const [state, dispatch] = reactExports.useReducer(cartReducer, initialState$1);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CartContext.Provider, { value: state, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CartDispatchContext.Provider, { value: dispatch, children }) });
}
...
function useCartDispatch() {
  const context = reactExports.useContext(CartDispatchContext);
  if (context === null) {
...
const selectReducer = (state, action) => {
  ...
  switch (action.type) {
    case "SET_SELECT":
      return ((_a = action.payload.items) == null ? void 0 : _a.length) ? action.payload.items.map((item) => ({
        id: item.id,
        selected: false
      })) : [];
    case "SYNC_WITH_CART": {
      if (!((_b = action.payload.items) == null ? void 0 : _b.length)) {
        return [];
      }
      const cartItemIds = action.payload.items.map((item) => item.id);
      const existingSelections = state.filter(
        (selectItem) => cartItemIds.includes(selectItem.id)
      );
      const newItems = action.payload.items.filter(
        (cartItem) => !existingSelections.some(
    ...
    case "ADD_SELECT":
      return state.map(
        (item) => item.id === action.payload.id ? { ...item, selected: true } : item
      );
    case "REMOVE_SELECT":
      return state.map(
        (item) => item.id === action.payload.id ? { ...item, selected: false } : item
      );
    case "SELECT_ALL":
...
const SelectDispatchContext = reactExports.createContext(null);
function SelectProvider({ children }) {
  const [state, dispatch] = reactExports.useReducer(selectReducer, [], loadInitialState);
  reactExports.useEffect(() => {
    saveStateToStorage(state);
  }, [state]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContext.Provider, { value: state, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectDispatchContext.Provider, { value: dispatch, children }) });
}
...
function useSelectDispatch() {
  const context = reactExports.useContext(SelectDispatchContext);
  if (context === null) {
...
async function fetcher(endpoint, options = {}) {
  ...
  return data.content !== void 0 ? data.content : data;
}
...
function useDataFetch(fetcher2, options = {}) {
  const { autoFetch = true, deps = [] } = options;
  const [data, setData] = reactExports.useState(null);
  const [loading, setLoading] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const prevDepsRef = reactExports.useRef(null);
  const depsChanged = reactExports.useCallback(() => {
  ...
  const executeFetch = reactExports.useCallback(async () => {
    if (!fetcher2)
      return;
    try {
      setLoading(true);
      setError(null);
      const result = await fetcher2();
      setData(result);
    } catch (error2) {
      console.error(`[useDataFetch] 에러 발생:`, error2);
  ...
  }, [autoFetch, fetcher2, depsChanged, executeFetch]);
  return {
    data,
    loading,
    error,
...
function useCart() {
  const fetcher2 = () => getCartItemList({
    page: 0,
    size: 20,
    sort: "asc"
  });
...
const CartDataLoader = ({ children }) => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "장바구니를 불러오는 중입니다..." });
  }
...
function CheckBox({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CheckBoxWrapper, { children: [
    ...
    text && /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "select-all", children: text })
  ] });
}
newStyled.h2`
  font-size: 24px;
...
const Description = newStyled.p`
  ...
  margin: 12px 0px;
`;
function TitleSection({ itemTypeCount }) {
...
const QuantityButton$1 = newStyled.button`
  ...
  background-color: white;
`;
const QuantityButtonText = newStyled.span`
  font-size: 12px;
  font-weight: 500;
  color: #0A0D13;
  margin: 0 12px;
...
function QuantityButton({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(QuantityButtonContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      QuantityButton$1,
      {
        onClick: onDecrease,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(QuantityButtonText, { children: quantity }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(QuantityButton$1, { onClick: onIncrease, disabled, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PlusIcon, {}) })
  ] });
}
...
function useCartItemManager({
  ...
  const selectState = useSelectContext();
  const selectDispatch = useSelectDispatch();
  const isSelected = ((_a = selectState.find((item) => item.id === cart.id)) == null ? void 0 : _a.selected) || false;
...
const CartItem = ({ cart, isReadOnly = false }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemContainer, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CartItemHeader, { children: !isReadOnly && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CheckBox, { isChecked: isSelected, onClick: handleSelect }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DeleteButton, { onClick: handleDelete, children: "삭제" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemInfo, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ProductImage, { src: imageUrl, alt: name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ItemTitle, { children: name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemPrice, { children: [
            price.toLocaleString("ko-KR"),
            "원"
          ] }),
          isReadOnly ? /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemTitle, { children: [
            cart.quantity,
            "개"
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
            QuantityButton,
...
class OrderCalculator {
   ...
   */
  static calculateOrderAmount(cartItems) {
   ...
   */
  static calculateItemCounts(cartItems) {
    return {
   ...
   */
  static calculateBaseDeliveryFee(orderAmount, isRemoteArea = false) {
    if (orderAmount >= ORDER_CONSTANTS.FREE_DELIVERY_THRESHOLD || orderAmount === 0) {
      return isRemoteArea ? ORDER_CONSTANTS.REMOTE_AREA_FEE : 0;
    }
    return ORDER_CONSTANTS.BASE_DELIVERY_FEE + (isRemoteArea ? ORDER_CONSTANTS.REMOTE_AREA_FEE : 0);
  }
  /**
   * 주문 요약 정보를 생성합니다.
   */
  static calculateOrderSummary(cartItems) {
...
const CartItemList = () => {
  ...
  if (cartData.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyCart, { children: "장바구니에 담은 상품이 없습니다." });
  }
  const orderSummary = OrderCalculator.calculateOrderSummary(cartData);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Content, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TitleSection, { itemTypeCount: orderSummary.itemTypeCount }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartItemList$1, { children: cartData.map((cart) => /* @__PURE__ */ jsxRuntimeExports.jsx(CartItem, { cart, isReadOnly: false }, cart.product.id)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description$1, { children: "⚠️ 총 주문 금액이 100,000원 이상일 경우 무료 배송됩니다." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Line$2, {})
  ] });
};
const initialState = [];
const couponSelectReducer = (state, action) => {
  var _a;
  switch (action.type) {
    case "SET_COUPON_SELECT":
      return ((_a = action.payload.coupons) == null ? void 0 : _a.length) ? action.payload.coupons.map((coupon) => ({
        id: coupon.id,
        selected: false
      })) : [];
...
const CouponSelectContext = reactExports.createContext(null);
const CouponSelectDispatchContext = reactExports.createContext(null);
function CouponSelectProvider({
  children
}) {
  const [state, dispatch] = reactExports.useReducer(couponSelectReducer, initialState);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CouponSelectContext.Provider, { value: state, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CouponSelectDispatchContext.Provider, { value: dispatch, children }) });
}
function useCouponSelectContext() {
  const context = reactExports.useContext(CouponSelectContext);
  if (context === null) {
    throw new Error(
...
function useCouponSelectDispatch() {
  const context = reactExports.useContext(CouponSelectDispatchContext);
  if (context === null) {
    throw new Error(
...
function useCoupon() {
  const fetcher2 = () => getCouponList();
  const { data, loading, error, refetch } = useDataFetch(fetcher2, {
    autoFetch: true,
    deps: []
  });
  return {
...
class CouponCalculator {
   ...
   * 시간 범위 내에 있는지 확인합니다.
   */
  static isTimeInRange(availableTime) {
    if (!availableTime)
      return true;
   ...
   */
  static calculateBogoDiscount(cartItems, coupon) {
   ...
   * 단일 쿠폰의 할인 금액을 계산합니다.
   */
  static calculateSingleCouponDiscount(coupon, orderInfo, alreadyAppliedCoupons = []) {
    ...
    switch (coupon.discountType) {
      ...
      case "freeShipping": {
        ...
        if (alreadyAppliedCoupons.some((c) => c.discountType === "freeShipping")) {
          return 0;
        }
        const baseDeliveryFee = originalOrderAmount >= ORDER_CONSTANTS.FREE_DELIVERY_THRESHOLD ? 0 : ORDER_CONSTANTS.BASE_DELIVERY_FEE;
   ...
   */
  static calculateDeliveryFeeWithCoupons(originalOrderAmount, isRemoteArea, appliedCoupons) {
   ...
   */
  static calculateSelectedCouponsDiscount(selectedCoupons, orderInfo) {
    let orderDiscount = 0;
   ...
   * 최적의 쿠폰 조합을 찾습니다.
   */
  static findOptimalCouponCombination(availableCoupons, orderInfo) {
    let bestResult = {
      totalDiscount: 0,
      deliveryDiscount: 0,
      appliedCoupons: [],
...
class OrderService {
   ...
   */
  static calculateBasicOrderBreakdown(cartItems, isRemoteArea = false) {
   ...
   */
  static calculateOrderBreakdownWithCoupons(cartItems, isRemoteArea, appliedCoupons = []) {
    const orderAmount = OrderCalculator.calculateOrderAmount(cartItems);
   ...
   */
  static convertCouponResultToOrderBreakdown(cartItems, couponResult, orderInfo) {
    const orderSummary = OrderCalculator.calculateOrderSummary(cartItems);
    return {
   ...
   * OrderInfo 객체를 생성합니다.
   */
  static createOrderInfo(cartItems, isRemoteArea) {
...
const PriceWrapper = newStyled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
  ...
  margin: 20px 0px;
`;
const OrderText = newStyled.p`
  font-size: 16px;
  font-weight: 700;
`;
const OrderPrice = newStyled.p`
  font-size: 24px;
  font-weight: 700;
`;
const Line = newStyled.hr`
  border: none;
  border-top: 1px solid rgba(0, 0, 0, 0.1);
  margin: 0;
`;
function OrderPriceSection({ priceInfo }) {
  const { orderPrice, deliveryPrice, couponDiscount, totalPrice } = priceInfo;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PriceWrapper, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(OrderText, { children: "주문 금액" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderPrice, { children: [
        orderPrice.toLocaleString("kr"),
        "원"
      ] })
    ] }),
    couponDiscount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(PriceWrapper, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(OrderText, { children: "쿠폰 할인 금액" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderPrice, { children: [
        couponDiscount.toLocaleString("kr"),
        "원"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PriceWrapper, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(OrderText, { children: "배송비" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderPrice, { children: [
        deliveryPrice.toLocaleString("kr"),
        "원"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Line, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PriceWrapper, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(OrderText, { children: "총 결제 금액" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderPrice, { children: [
...
const OrderSection = () => {
  ...
  const selectedCoupons = reactExports.useMemo(() => {
    const selectedIds = selectedCouponStates.filter((state) => state.selected).map((state) => state.id);
    return couponList.filter((coupon) => selectedIds.includes(coupon.id));
  }, [selectedCouponStates, couponList]);
  const { orderBreakdown, selectedCartItem } = reactExports.useMemo(() => {
    const selectedCartData = cartData.filter(
      (_, idx) => {
        var _a;
        return (_a = selectData[idx]) == null ? void 0 : _a.selected;
      }
    );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(OrderPriceSection, { priceInfo }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      OrderButton,
      {
...
const CartPage = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root$2, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CartPageWrapper, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { showBackButton: true, onBackClick: () => {
    } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartDataLoader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CartContentWrapper, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderTitle$1, { children: "장바구니" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CartItemList, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(OrderSection, {})
    ] }) })
  ] }) });
};
const Root$1 = newStyled.div`
  background-color: #a2a2a2;
  height: 100vh;
`;
const OrderCompletePageWrapper$1 = newStyled.div`
  width: 430px;
  height: 100vh;
  background-color: #ffffff;
  margin: 0 auto;
  position: relative;
`;
const OrderResultWrapper$1 = newStyled.div`
  width: 100%;
...
const ButtonContainer$1 = newStyled.div`
  ...
  gap: 0;
`;
const PaymentButton$1 = newStyled.button`
  flex: 1;
  height: 60px;
  background-color: #000000;
  color: #ffffff;
...
newStyled.div`
  ...
  padding: 20px;
`;
const OrderResultTitle = newStyled.p`
  font-size: 24px;
  font-weight: 700;
  margin-bottom: 24px;
`;
const OrderResultDescription = newStyled.div`
  font-size: 12px;
  color: #666666;
  line-height: 1.5;
`;
const OrderResultPriceTitle = newStyled.p`
  font-size: 16px;
  font-weight: 700;
  margin-top: 24px;
`;
const OrderResultPrice = newStyled.p`
  font-size: 24px;
  font-weight: 700;
  margin-top: 12px;
`;
function OrderResult({
  ...
  const titleText = orderStatus === "order-complete" ? "주문 확인" : "결제 확인";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(OrderResultTitle, { children: titleText }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderResultDescription, { children: [
      orderSummary.summaryText,
      "를 주문합니다."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OrderResultDescription, { children: "최종 결제 금액을 확인해 주세요." }),
    orderStatus === "check-payment" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(OrderResultPriceTitle, { children: "총 결제 금액" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderResultPrice, { children: [
        totalPrice.toLocaleString("kr"),
        "원"
      ] })
    ] })
...
const CheckPaymentPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderCompletePageWrapper$1, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { showBackButton: false, title: "" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OrderResultWrapper$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      OrderResult,
      {
        orderSummary,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonContainer$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PaymentButton$1, { onClick: handleBackToCart, children: "결제하기" }) })
  ] }) });
};
const Root = newStyled.div`
  ...
  height: 100vh;
`;
const OrderCompletePageWrapper = newStyled.div`
  width: 430px;
  height: 100vh;
  background-color: #ffffff;
  margin: 0 auto;
  position: relative;
`;
const OrderResultWrapper = newStyled.div`
  width: 100%;
...
`;
const DeliveryInfo = newStyled.div`
  width: 100%;
  height: 48px;
  display: flex;
  flex-direction: column;
  ...
  margin-bottom: 32px;
`;
const DeliveryInfoTitle = newStyled.div`
  font-size: 16px;
  font-weight: bold;
  color: #000000;
`;
const ButtonContainer = newStyled.div`
  ...
  gap: 0;
`;
const PaymentButton = newStyled.button`
  flex: 1;
  height: 60px;
  background-color: #000000;
  color: #ffffff;
...
`;
const ModalOverlay = newStyled.div`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
const ModalContent = newStyled.div`
  ...
  overflow: auto;
`;
const TitleSpacer = newStyled.div`
  height: 32px;
`;
const CouponDescription = newStyled.div`
  margin-bottom: 0;
  color: #000;
  font-size: 12px;
`;
const LoadingMessage = newStyled.div`
  text-align: center;
  padding: 40px;
`;
const ErrorMessage = newStyled.div`
  ...
  color: #ff4444;
`;
const EmptyMessage = newStyled.div`
  text-align: center;
  padding: 40px;
  color: #666;
`;
const CouponList = newStyled.div`
  ...
  flex-direction: column;
`;
const CouponDivider = newStyled.hr`
  margin: 0;
  border: none;
...
const CouponContent = newStyled.div`
  ...
  flex: 1;
`;
const CouponCheckboxWrapper = newStyled.div`
  display: flex;
  flex-direction: row;
  align-items: center;
  ...
  gap: 8px;
`;
const CouponName = newStyled.div`
  font-weight: bold;
  margin-bottom: 4px;
  font-size: 14px;
`;
const CouponExpiry = newStyled.div`
  font-size: 12px;
  color: #000;
  margin-bottom: 2px;
`;
const CouponDetail = newStyled.div`
  font-size: 12px;
  color: #000;
  margin-bottom: 2px;
`;
...
const useCouponCalculation = ({
  ...
  const orderInfo = reactExports.useMemo(() => {
    return OrderService.createOrderInfo(cartItems, isRemoteArea);
  }, [cartItems, isRemoteArea]);
  const selectedCouponResult = reactExports.useMemo(() => {
    return CouponCalculator.calculateSelectedCouponsDiscount(
      selectedCoupons,
      orderInfo
    );
  }, [selectedCoupons, orderInfo]);
  const finalTotalAmount = reactExports.useMemo(() => {
    return selectedCouponResult.finalOrderAmount + selectedCouponResult.finalDeliveryFee;
...
class CouponFormatter {
   ...
   * 쿠폰의 상세 정보를 포맷팅합니다.
   */
  static getCouponDetails(coupon) {
    const details = [];
...
function CouponModal({
  ...
  const selectedCouponIds = couponSelectState.filter((item) => item.selected).map((item) => item.id);
  ...
  const handleCouponSelect = (couponId) => {
    ...
    if (currentItem == null ? void 0 : currentItem.selected) {
      couponSelectDispatch({
      ...
      onApplyCoupons(newSelectedCoupons);
    } else {
      if (selectedCount >= 2) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ModalOverlay, { onClick: handleClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalContainer, { onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ModalTitle, { children: "쿠폰을 선택해주세요" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CloseButton, { onClick: handleClose, children: "×" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TitleSpacer, {}),
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingMessage, { children: "쿠폰을 불러오는 중..." }) : error ? /* @__PURE__ */ jsxRuntimeExports.jsxs(ErrorMessage, { children: [
        "쿠폰을 불러오는데 실패했습니다: ",
        error
      ] }) : couponList.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyMessage, { children: "사용 가능한 쿠폰이 없습니다." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CouponDescription, { children: "⚠️ 쿠폰은 최대 2개까지 사용할 수 있습니다." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CouponList, { children: couponList.map((coupon) => {
          const selectState = couponSelectState.find(
            (item) => item.id === coupon.id
          );
          const isSelected = (selectState == null ? void 0 : selectState.selected) || false;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CouponDivider, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              CouponItem,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CouponCheckboxWrapper, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      CheckBox,
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CouponName, { children: coupon.description })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CouponContent, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(CouponExpiry, { children: [
                      "만료일: ",
                      formatDate(coupon.expirationDate)
                    ] }),
                    CouponFormatter.getCouponDetails(
                      coupon
                    ).map((detail, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(CouponDetail, { children: detail }, idx))
                  ] })
                ]
              }
            )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ModalFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ApplyButton, { onClick: handleApply, disabled: !hasSelectedCoupons, children: hasSelectedCoupons ? `총 ${totalDiscount.toLocaleString()}원 할인 쿠폰 사용하기` : "쿠폰을 선택해주세요" }) })
  ] }) });
}
const OrderCompletePage = () => {
  ...
  const state = location.state;
  const originalOrderAmount = reactExports.useMemo(() => {
    return OrderCalculator.calculateOrderAmount((state == null ? void 0 : state.selectedCartItem) || []);
  }, [state == null ? void 0 : state.selectedCartItem]);
  const { finalDeliveryFee, totalDiscount, finalTotalAmount } = useCouponCalculation({
    cartItems: (state == null ? void 0 : state.selectedCartItem) || [],
    isRemoteArea,
  ...
  const handleApplyCoupons = (selectedCoupons) => {
    setAppliedCoupons(selectedCoupons);
  };
  const orderSummary = OrderCalculator.calculateOrderSummary(
    state.selectedCartItem
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CouponSelectProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Root, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderCompletePageWrapper, { style: { position: "relative" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { showBackButton: true, onBackClick: handleBackToCart }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OrderResultWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      OrderResult,
      {
        orderSummary,
        totalPrice: finalTotalAmount,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CartItemWrapper, { children: [
      state.selectedCartItem.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(CartItem, { cart: item, isReadOnly: true }, item.id)),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CouponButton, { onClick: handleCouponButtonClick, children: appliedCoupons.length > 0 ? `쿠폰 적용됨 (${appliedCoupons.length}개)` : "쿠폰 적용" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DeliveryInfo, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DeliveryInfoTitle, { children: "배송 정보" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CheckBox,
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PaymentButton, { onClick: handleCheckPayment, children: "결제하기" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CouponModal,
      {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CartProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CouponSelectProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(CartPage, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/order-complete", element: /* @__PURE__ */ jsxRuntimeExports.jsx(OrderCompletePage, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/check-payment", element: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckPaymentPage, {}) })
  ] }) }) }) });
}
const basename = "/react-shopping-cart";
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { basename, children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
